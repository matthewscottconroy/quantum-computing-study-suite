...
class SetupScreen(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QLabel("QEC Trainer")
        title.setObjectName("heading")
        sub = QLabel("Master quantum error correction — repetition codes, stabilizer formalism, "
                     "Steane code, surface code, and fault tolerance.")
        ...
        tip = QLabel(
            "Multiple-choice problems are auto-graded instantly.\n\n"
            "Open-ended explanation questions are graded by Claude (API key required).\n\n"
            "After each problem you see a full explanation with the key concepts."
        )
