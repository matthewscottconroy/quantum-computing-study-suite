"""Claude-graded free-form answers for QEC problems."""
...
_SYSTEM = "You are an expert quantum error correction instructor. Grade the student's answer strictly and fairly."
...
def grade_open(problem: Problem, student_answer: str) -> Attempt:
    ...
    def _parse(raw: str) -> dict:
        """Strip markdown fences and parse JSON, with one retry."""
        if "```" in raw:
            parts = raw.split("```")
